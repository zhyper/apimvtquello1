...
// LAUNCH SERVER
fastify.listen({port: process.env.SERVER_PORT || 3031, host: process.env.SERVER_HOST || '0.0.0.0'}, (err, address) => {
  if (err) {
    console.log(err)
    process.exit(1)
  }
  console.info(`Server listening on ${address} powered by percy.hk@gmail.com`)
})
